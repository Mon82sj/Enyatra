...
const Sidebar = ({ children }) => {
  ...
  const navItems = [
    { label: "Parent Home " , path: "/dashboard", icon: <HouseDoor size={22} /> },
    { label: "Parent Dashboard", path: "/parent-details", icon: <Map size={22} /> },
 { label: "Parent Community Spaces", path: "/parent-community", icon: <BarChartSteps size={22} /> },
    // { label: "Chatbot", path: "/entire-page-bot", icon: <Robot size={22} /> },
    // { label: "Career Compare", path: "/career-compare", icon: <Book size={22} /> },
    // { label: "GenAI Quiz", path: "/genai-questions", icon: <InfoCircle size={22} /> },
    ...
    >
      ...
      >
        <Card.Body className="text-info" style={{color:"#1f89a1"}}>
          ...
          <Nav className="flex-column gap-3" style={{color:"#1f89a1"}}>
