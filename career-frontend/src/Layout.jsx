...
import logo from "./assets/என்yatra logo.png";
...
function Layout({ children }) {
    ...
    return (
      <div className="d-flex flex-column min-vh-100" style={{ width: "100vw", backgroundColor: "#EBF4F6" }}>
        ...
        >
         <Container fluid>
      <Navbar.Brand as={Link} to="/" className="fw-bold fs-2 me-auto" style={{color:"#1f89a1"}}><img src={logo} width={"240px"} height={"90px"} style={{marginTop:"-9px"}} title="The career guidance platform"/>
